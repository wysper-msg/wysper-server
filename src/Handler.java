...
/**
 * Handler implements the abstract structure for handling messages from clients and accessing the
 * database as necessary. Intended to be extended by other classes.
 */
abstract class Handler implements HttpHandler {
   ...
   */
  protected abstract String accessDB(String req) throws ParseException;
...
class PullHandler extends Handler {
  ...
  /**
   * Get all the messages in the database that were sent since the last time this user requested new
   * messages
   *
   * @param req the user's username
